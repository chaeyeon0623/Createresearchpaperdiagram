...
const initialData = [
  ...
  { name: '3월', value: 600, value2: 980 },
  { name: '4월', value: 800, value2: 390 },
  { name: '5월', value: 700, value2: 480 },
  { name: '6월', value: 900, value2: 620 },
];

export function LineChartEditor() {
  const [data, setData] = useState(initialData);
  const [title, setTitle] = useState('선 그래프');
  const [xAxisLabel, setXAxisLabel] = useState('시간');
  const [yAxisLabel, setYAxisLabel] = useState('값');
  const [line1Label, setLine1Label] = useState('시리즈 1');
  const [line2Label, setLine2Label] = useState('시리즈 2');

  const addDataPoint = () => {
    const months = ['1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월'];
    setData([...data, { name: months[data.length % 12], value: 0, value2: 0 }]);
  };
      ...
      <div className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label htmlFor="yaxis">Y축 라���</Label>
              <Input
                id="yaxis"
                value={yAxisLabel}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label htmlFor="line1">선 1 이름</Label>
                <Input
                  id="line1"
                  value={line1Label}
                  onChange={(e) => setLine1Label(e.target.value)}
                />
              </div>
              <div>
                <Label htmlFor="line2">선 2 이름</Label>
                <Input
                  id="line2"
                  value={line2Label}
                  onChange={(e) => setLine2Label(e.target.value)}
                />
              </div>
            </div>
          </CardContent>
